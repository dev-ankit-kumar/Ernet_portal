  ...
  const menuItems = [
    {
      ...
      href: "/components/Adduser", // Path based on your file structure
    ...
    },
    {
      ...
      href: "/VM/new", // Changed from href to href
    ...
    },
    {
      ...
      href: "/VM", // Changed from href to href
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="w-full h-20 rounded- flex items-center justify-center text-white font-bold">
                  <Image
                    src="/logo.png" // Make sure the image is placed inside /public
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Menu Grid - Modified to use onClick with router */}
